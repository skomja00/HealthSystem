...
public class DbMods {
    ...
    public static String delete(String userId, DbConn dbc) {
        ...
        if (userId == null) {
            return "Error in modelPatientVisit.DbMods.delete: cannot delete PatientVisit record because 'userId' is null";
        }
        ...
        try {
            ...
            String sql = "DELETE FROM PatientVisit WHERE MedRecNo = ?";
            ...
            result = "Exception thrown in model.patientVisit.DbMods.delete(): " + e.getMessage();
        }
