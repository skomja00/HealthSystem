...
<%
    ...
    // Test URL tamper:
    //http://localhost:8080/3308-LA07a-insert/webAPIs/insertPatientVisitSimpleAPI.jsp?jsonData={"patientName":"LA07a, Sudhir","imageUrl":"https://cis.temple.edu/sites/default/files/styles/portrait-small/public/user_pictures/picture-306-1445703546.jpg?itok=RZ9qp8Ep","medRecNo":"TUN37331","description":"Vaccination","visitDateTime":"03/16/2020 2:35 PM","diagnosis":"Influenza virus vaccine","visitCharge":"52.50","webUserId":"10","errorMsg": ""}
    ...
    if (jsonInsertData == null) {
        ...
        if (errorMsgs.errorMsg.length() == 0) { // means db connection is ok
            ...
            */
            ...
            errorMsgs.visitDateTime = ValidationUtils.dateValidationMsg(insertData.visitDateTime, false);
            ...
            if (errorMsgs.getCharacterCount() > 0) {  // at least one field has an error, don't go any further.
                ...
                String sql = "INSERT INTO PatientVisit (PatientName, ImageUrl, MedRecNo, Description, VisitDateTime, Diagnosis, VisitCharge, web_user_id_fk)"
                        + " values (?,?,?,?,?,?,?,?)";
                ...
                pStatement.setDate(5, ValidationUtils.dateTimeConversion(insertData.visitDateTime));
