...
public class StringDataList {
    ...
    public ArrayList<StringData> patientVisitList = new ArrayList();
    ...
    public void add(StringData stringData) {
        this.patientVisitList.add(stringData);
    }

    // Creates a StringData element from a ResultSet (from SQL select statement), 
