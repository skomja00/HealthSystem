...
--	/* web_users are the people who entered the data into the database */
...
-- 
	...
	INSERT INTO `web_user` 
		(`user_email`,              `user_password`,`image`,                                                       `birthday`,  `membership_fee`,`user_role_id`) values
		('nulls.user@gmail.com',   null,           null,	                                                        null,        null,            null);
	INSERT INTO `web_user` 
		(`user_email`,              `user_password`,`image`,                                                       `birthday`,  `membership_fee`,`user_role_id`) values 
		('services.s@gmail.com', 'eeditor',       'http://cis-linux2.temple.edu/~sallyk/pics_user/tony.jpg',   '2002-01-01', 0.00,            get_user_role_id('services'));
	INSERT INTO `web_user` 
		(`user_email`,              `user_password`,`image`,                                                       `birthday`,  `membership_fee`,`user_role_id`) values 
	...
	INSERT INTO `web_user` 
		(`user_email`,              `user_password`,`image`,                                                       `birthday`,  `membership_fee`,`user_role_id`) values 
		('documents.d@gmail.com', 'eeditor',  'http://cis-linux2.temple.edu/~sallyk/pics_user/tony.jpg',   '2002-01-01', 0.00,            get_user_role_id('documents'));
	INSERT INTO `web_user` 
		(`user_email`,              `user_password`,`image`,                                                       `birthday`,  `membership_fee`,`user_role_id`) values
...
-- /**
--  * Create patient_visit/"other" table 
-- */
CREATE TABLE `patient_visit` (
	...
	`DschDateTime` datetime DEFAULT NULL,
	`Diagnosis` varchar(255) DEFAULT NULL,
	`visit_charge` decimal(14,3) DEFAULT NULL,
	`web_user_id_fk` int(11) NOT NULL,
	PRIMARY KEY (`Visit_Id`),
	UNIQUE KEY `MedRecNo_UNIQUE` (`MedRecNo`),
	KEY `web_user_id_fk` (`web_user_id_fk`),
